...
Version: 2.4
Plugin URI: http://wiki.schwink.net/index.php?title=Wordpress_CAS_authentication
Description: Authenticate users using the phpCAS package (http://www.ja-sig.org/wiki/display/CASC/phpCAS).
Author: Stephen Schwink
Author URI: http://schwink.net
License: GPLv2
*/

/* Copyright (C) 2008 Stephen Schwink (wordpress {} schwink <> net)
